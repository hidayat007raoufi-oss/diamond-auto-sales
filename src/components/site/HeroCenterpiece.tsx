  ...
  return (
    ...
    >
      ...
      >
        <div
          aria-hidden
          className="absolute left-1/2 top-1/2 h-[80%] w-[80%] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle,rgba(170,186,210,0.26),transparent_62%)] blur-2xl"
        />

        {/* telemetry ring — ticks */}
        <svg viewBox="0 0 320 320" className="spin-slow absolute inset-0 h-full w-full">
          <circle cx={C} cy={C} r="150" fill="none" stroke="rgba(196,210,230,0.18)" strokeWidth="1" strokeDasharray="2 9" />
          {ticks.map((t, i) => (
        ...
        <svg viewBox="0 0 320 320" className="spin-rev absolute inset-0 h-full w-full">
          ...
          <path d="M40 160 a120 120 0 0 1 60 -104" fill="none" stroke="rgba(196,210,230,0.42)" strokeWidth="1.5" strokeLinecap="round" />
          <path d="M280 160 a120 120 0 0 1 -60 104" fill="none" stroke="rgba(196,210,230,0.42)" strokeWidth="1.5" strokeLinecap="round" />
        </svg>
          ...
          <svg viewBox="0 0 320 320" className="h-full w-full">
            <defs>
              <linearGradient id="cg" x1="0" y1="0" x2="0.4" y2="1">
                ...
                <stop offset="0.5" stopColor="#94a0b0" />
