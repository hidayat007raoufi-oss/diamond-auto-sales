  ...
  return (
    <>
      <button
        ...
        className="group relative block aspect-[4/3] w-full cursor-zoom-in overflow-hidden rounded-2xl bg-[#0c0c0e] ring-1 ring-white/10"
      >
        <div className="absolute inset-0" style={{ background: tone }} />
        <PhotoLayer src={src} alt={alt} eager />
        <span className="absolute left-5 top-5 rounded-full border border-white/15 bg-black/50 px-3 py-1 text-[11px] tracking-widest text-white/80 shadow-sm backdrop-blur">
          27-Point Inspected
        </span>
        <span className="absolute bottom-5 right-5 grid h-9 w-9 place-items-center rounded-full border border-white/15 bg-black/50 text-white/80 shadow-sm backdrop-blur transition-transform duration-300 group-hover:scale-110">
