      ...
      <div className="mx-auto grid max-w-7xl gap-16 px-5 pb-28 pt-36 sm:px-8 sm:pb-36 lg:grid-cols-[1fr_1.05fr] lg:items-center">
        <div>
          <SectionHeading
            ...
            intro="Apply online or speak with our team to explore options for your next vehicle. Every credit situation considered, trade-ins welcome."
          />

          <ul className="mt-10 space-y-4">
            {points.map((p, i) => (
              <Reveal key={p} delay={i * 80}>
                <li className="flex items-start gap-3.5 text-[15px] text-zinc-700">
                  <svg viewBox="0 0 24 24" className="mt-0.5 h-5 w-5 shrink-0 text-zinc-900" fill="none" stroke="currentColor" strokeWidth="2">
